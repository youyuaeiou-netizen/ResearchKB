...
export function ContentViewport({ activeTab, children }: { activeTab: V2TabKey; children: ReactNode }) {
  ...
  return <main id={"tab-modal-v2-panel-" + activeTab} className={`tab-modal-v2__content-viewport tab-modal-v2__content-viewport--${activeTab} obsui-v1__content-viewport`} role="tabpanel" aria-label={tab.label + "公共内容区域"}>
